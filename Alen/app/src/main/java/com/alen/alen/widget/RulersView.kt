...
class RulersView : View {
    ...
    private var mTextHeight: Float = 0.toFloat()            //尺子刻度下方数字  的高度

    private var mTextPaint: Paint? = null             // 尺子刻度下方数字( 也就是每隔10个出现的数值) paint
    private var mLinePaint: Paint? = null             //  尺子刻度  paint
    ...
    fun init(context: Context, attrs: AttributeSet) {
        ...
        mLineWidth = myFloat(2.0f)
        mLineMaxHeight = myFloat(100.0f)
        mLineMidHeight = myFloat(60.0f)
        mLineMinHeight = myFloat(40.0f)
        mTextHeight = myFloat(40.0f)
    ...
    fun myFloat(paramFloat: Float): Float {
